    ...
    public partial class CreateDatabaseTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategorieOffers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CategorieOffers_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategorieOffers_Offers_OfferId",
                        column: x => x.OfferId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfferTranslations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OfferTranslations_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GuestCarts_Variants_VariantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserCarts_Variants_VariantId",
                        column: x => x.VariantId,
                        principalTable: "Variants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VariantImages_MediaAssets_MediaAssetId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategorieOffers_CategoryId",
                table: "CategorieOffers",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CategorieOffers_OfferId_CategoryId",
                table: "CategorieOffers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ColorTranslations_ColorId_LanguageId",
                table: "ColorTranslations",
                columns: new[] { "ColorId", "LanguageId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OfferTranslations_LanguageId",
                table: "OfferTranslations",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_OfferTranslations_OfferId_LanguageId",
                table: "OfferTranslations",
                columns: new[] { "OfferId", "LanguageId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductOffers_OfferId_ProductId",
                table: "ProductOffers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VariantImages_MediaAssetId",
                table: "VariantImages",
                column: "MediaAssetId");
